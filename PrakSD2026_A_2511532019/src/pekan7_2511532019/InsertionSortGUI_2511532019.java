...
public class InsertionSortGUI_2511532019 extends JFrame {
	 ...
	 * Create the frame.
	 */
	public InsertionSortGUI_2511532019() {
	...
	private void performStep() {
		if (i_2019<array_2019.length && sorting_2019) {
			int key = array_2019[i_2019];
			j_2019=i_2019-1;
			
			StringBuilder stepLog=new StringBuilder();
			stepLog.append("Langkah" ).append(stepCount_2019).append(":Memasukkan ").append(key).append("\n");
			
			while (j_2019>=0 && array_2019[j_2019]>key) {
				array_2019[j_2019+1]=array_2019[j_2019];
				j_2019--;
			}
			array_2019 [j_2019+1]=key;
			
			updateLabels();
			stepLog.append("Hasil: ").append(arrayToString(array_2019)).append("\n\n");
			stepArea_2019.append(stepLog.toString());
			i_2019++;
			stepCount_2019++;
			
			if (i_2019==array_2019.length) {
				sorting_2019=false;
				stepButton_2019.setEnabled(false);
	...
	public static void main (String[] args) {
		SwingUtilities.invokeLater(()->{
			InsertionSortGUI_2511532019 gui=new InsertionSortGUI_2511532019();
			gui.setVisible(true);
		});
	}
}
